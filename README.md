...
To look at existing files, click on any file that ends in `.md`, for example [`aboutme.md`](schedule.md). On the next page you can see some nicely formatted text (there's a word in bold, a link, a few bullet points), and if you click on the pencil icon to edit the file, you'll see the markdown code that generated the pretty text. Very easy!
